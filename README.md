...
This project help detect employees at flight risk. The model build algorithms based on the correlation patterns of data attributes of employee who left voluntarily and extends to existing employees to identify employees that are likely to leave.
